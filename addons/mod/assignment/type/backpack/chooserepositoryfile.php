 ...
 * @access public
 */
class MoodleQuickForm_chooserepositoryfile extends MoodleQuickForm_group {
    /**
    * Options for element :
    *
    ...
    */
    function MoodleQuickForm_chooserepositoryfile($elementName = null, $elementLabel = null, $options = array(), $attributes = null) {
        $this->HTML_QuickForm_element($elementName, $elementLabel, $attributes);
        $this->_appendName = true;
        $this->_type       = 'chooserepositoryfile';
    ...
    function _createElements() {
        ...
        if ($this->_options['shared'] === null) {
            $shared = '';
        } else {
            $shared = $this->_options['shared'];
        }

        if ($this->_options['userid'] === null) {
            $userid = '';
        } else {
        ...
        $url    = '/file/repository/index.php?id=' . $courseid . '&shared=' . $shared . '&userid=' . $userid .
                  '&choose=' . $choose;

        if ($this->_options['options'] == 'none') {
            $options = 'menubar=0,location=0,scrollbars,resizable,width=' . $this->_options['width'] . ',height=' .
